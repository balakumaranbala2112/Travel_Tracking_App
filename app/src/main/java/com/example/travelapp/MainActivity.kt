        ...
        Column(
            ...
            Card(
                modifier = Modifier
                    ...
                    .height(250.dp)
                    .clickable {
                        context.startActivity(Intent(context, CanadaActivity::class.java))
                    },
                elevation = 8.dp
            ) {
                Column(horizontalAlignment = Alignment.CenterHorizontally) {
                    ...
                    Text(text = stringResource(id = R.string.place_canada), fontSize = 18.sp)
                    Text(
                        text = stringResource(id = R.string.description),
                        fontWeight = FontWeight.Light,
                        fontSize = 16.sp,
            ...
            // 05: Dubai (Newly Added)
            Card(
                modifier = Modifier
                    .fillMaxWidth()
                    .height(250.dp)
                    .clickable {
                        context.startActivity(Intent(context, DubaiActivity::class.java))
                    },
                elevation = 8.dp
            ) {
                Column(horizontalAlignment = Alignment.CenterHorizontally) {
                    ...
                    Text(text = stringResource(id = R.string.place_dubai), fontSize = 18.sp)
                    Text(
                        text = stringResource(id = R.string.dubai_description),
                        fontWeight = FontWeight.Light,
                        fontSize = 16.sp,
                        textAlign = TextAlign.Center
                    )
